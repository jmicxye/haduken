...
def make_embed(group_info, date):
    return dict(
        ...
        fields=[
            dict(name="**Group Info**", value=f"**‣ ID:** {group_info['id']}\n**‣ Name:** {group_info['name']}\n**‣ Members:** {group_info['memberCount']}\n**‣ Created:** No Working\n\n"),
            dict(name="ㅤ", value=f"**‣ Funds/Robux:** Not Working\n**‣ Clothings** {clothingcount(group_info['id'])}\n**‣ Game Visits:** {mostvisitegame(group_info['id'])}\n\n"),
        ],
        author=dict(
          name="Micx Finder",
          icon_url="https://media.discordapp.net/attachments/1001943657206784010/1004144722165633124/8f5e7675e835c33677b924016937317c.png"
        ),
       color=random.randint(10000, 50000),
      
        footer=dict(
            text="Micx Finder | Hosted by Micx $ idk",
            icon_url="https://media.discordapp.net/attachments/1001943657206784010/1004144722165633124/8f5e7675e835c33677b924016937317c.png"
        ),
     thumbnail=dict(url='https://media.discordapp.net/attachments/1001943657206784010/1004144722165633124/8f5e7675e835c33677b924016937317c.png')
    )
